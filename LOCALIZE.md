...
ゴミの収集日の変更など、特別なお知らせがある場合に記述します
...
の形で記述してください。
* **表示開始**: 表示を開始する日付を記述してください。指定日の00時00分から表示を開始します。

* **表示終了**: 表示を終了する日付を記述してください。指定日の00時00分に表示を終了します。

* **お知らせ内容**: お知らせ内容を記述してください。

* **色**: お知らせの文字の色を指定してください。

例えば2018年12月25日~2019年1月5日(6日の0時0分)までお知らせを表示する場合は、以下のようになります。

```
20181225,20190106,年末年始は収集を行いません。,#FF0000
```
